...
<form action="${ctx}/login.action" method="post" id="index_login" class="layout_form" style="width:440px; height:230px;">
	<div class="window">
	    <div>
	        <dl>
	            <dt><fmt:message key="index_userLogin"/> <a href="javascript:void(0);" class="close">&nbsp;&nbsp;&nbsp;</a></dt>
	    ...
	    <div class="win_save"><a href="javascript:void(0);" class="login_submit"><fmt:message key="index_login_login"/></a><a href="javascript:void(0);" class="close"><fmt:message key="text_cancel"/></a></div>
	</div>
</form>