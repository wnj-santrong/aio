	...
	<div class="window">
	    <div>
	        <dl>
	            ...
	            <dd><p><fmt:message key="index_login_username"/>:</p><span><input name="username" type="text" class="form_text" value="" required /></span></dd>
	            <dd><p><fmt:message key="index_login_password"/>:</p><span><input name="password" type="password" class="form_text" value="" required /></span></dd>
	        </dl>
	    </div>
