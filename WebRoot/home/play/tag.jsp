	...
	<div class="window">
	    <div>
	        <dl>
	            ...
	            <dd><span class="tit"><fmt:message key="play_priority"/>:</span><span class="cont"><input name="priority" type="text"  class="form_text" value="${tag.priority}" required_Number/></span></dd>
	        </dl>
	    </div>
