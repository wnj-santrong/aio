...
public interface MeetingMapper {
	...
	@Update("update web_meeting set courseName=#{courseName}, teacher=#{teacher}, remark=#{remark}, bitRate=#{bitRate}, resolution=#{resolution}, maxTime=#{maxTime}, useRecord=#{useRecord}, recordMode=#{recordMode}, recordType=#{recordType}, uts=#{uts} where id=#{id}")
